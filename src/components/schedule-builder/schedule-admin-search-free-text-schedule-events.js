...
class ScheduleAdminSearchFreeTextScheduleEvents extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    if (this.props.currentValue) this.searchTxt.value = this.props.currentValue;
  }
          ...
          <div className="input-group">
            <input
              ...
              placeholder={T.translate(
                "schedule.placeholders.search_published"
              )}
            ...
            <span className="input-group-btn" style={{ width: 5 + "%" }}>
              ...
              <button
                ...
                title={T.translate("schedule.find_empty_spots")}
                onClick={onFindEmptyClick}
              >
                Find Empty
              </button>
            </span>
