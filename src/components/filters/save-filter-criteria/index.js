...
const SaveFilterCriteria = ({ onSave, selectedFilterCriteria }) => {
  ...
  useEffect(() => {
    if (selectedFilterCriteria?.name)
      setCustomName(selectedFilterCriteria.name);
    if (selectedFilterCriteria?.visibility)
      setVisibility(selectedFilterCriteria.visibility);
      ...
      <div className={`${styles.saveAs} col-xs-4`}>
        ...
        <Input
          ...
          placeholder={T.translate(
            "save_filter_criteria.placeholders.custom_name"
          )}
