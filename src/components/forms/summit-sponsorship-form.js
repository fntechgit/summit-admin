...
class SummitSponsorshipForm extends React.Component {
  ...
  render() {
    ...
    const sponsorship_ddl = sponsorships.map((s) => ({
      label: s.name,
      value: s.id
    }));
        ...
        <div className="row form-group">
          <div className="col-md-6 checkboxes-div">
            <div className="form-check abc-checkbox">
              <input
                type="checkbox"
                id="sponsor_page_use_disqus_widget"
              ...
              <label
                ...
                htmlFor="sponsor_page_use_disqus_widget"
              >
                {T.translate(
          ...
          <div className="col-md-6 checkboxes-div">
            <div className="form-check abc-checkbox">
              <input
                type="checkbox"
                id="sponsor_page_use_live_event_widget"
              ...
              <label
                className="form-check-label"
                htmlFor="sponsor_page_use_live_event_widget"
              >
                {T.translate(
        ...
        <div className="row form-group">
          <div className="col-md-6 checkboxes-div">
            <div className="form-check abc-checkbox">
              <input
                type="checkbox"
                id="sponsor_page_use_banner_widget"
              ...
              <label
                className="form-check-label"
                htmlFor="sponsor_page_use_banner_widget"
              >
                {T.translate(
          ...
          <div className="col-md-6 checkboxes-div">
            <div className="form-check abc-checkbox">
              <input
                type="checkbox"
                id="sponsor_page_use_schedule_widget"
              ...
              <label
                className="form-check-label"
                htmlFor="sponsor_page_use_schedule_widget"
              >
                {T.translate(
        ...
        <div className="row form-group">
          <div className="col-md-6 checkboxes-div">
            <div className="form-check abc-checkbox">
              <input
                type="checkbox"
                id="should_display_on_expo_hall_page"
              ...
              <label
                className="form-check-label"
                htmlFor="should_display_on_expo_hall_page"
              >
                {T.translate(
          ...
          <div className="col-md-6 checkboxes-div">
            <div className="form-check abc-checkbox">
              <input
                type="checkbox"
                id="should_display_on_lobby_page"
              ...
              <label
                className="form-check-label"
                htmlFor="should_display_on_lobby_page"
              >
                {T.translate(
