            ...
            <form className="badge-settings-form">
                ...
                <div className="row form-group">
                    <div className='col-md-6'>
                        <label>{T.translate("badge_settings.badge_template_background_img")}</label><br />
                        <UploadInput
                            id="BADGE_TEMPLATE_BACKGROUND_IMG"
                            value={entity?.BADGE_TEMPLATE_BACKGROUND_IMG?.file_preview || entity?.BADGE_TEMPLATE_BACKGROUND_IMG?.file}
                    ...
                    <div className='col-md-6 form-group'>
                        <label>{T.translate("badge_settings.badge_template_first_name_color")}</label><br />
                        <HexColorInput
                    ...
                    <div className='col-md-6 form-group'>
                        <label>{T.translate("badge_settings.badge_template_last_name_color")}</label><br />
                        <HexColorInput
                            onChange={this.handleChange}
                    ...
                    <div className='col-md-6 form-group'>
                        <label>{T.translate("badge_settings.badge_template_company_color")}</label><br />
                        <HexColorInput
                            onChange={this.handleChange}
