      ...
      <form className="registration-invitation-form">
        ...
        <div className="row form-group">
          <div className="col-md-4">
            <label>
              {" "}
              {T.translate("edit_registration_invitation.first_name")}
            </label>
            &nbsp;
            <i
              ...
              aria-hidden="true"
              title={T.translate(
                "edit_registration_invitation.first_name_info"
              )}
            />
            <Input
              id="first_name"
          ...
          <div className="col-md-4">
            <label>
              {" "}
              {T.translate("edit_registration_invitation.last_name")}
            </label>
            &nbsp;
            <i
              className="fa fa-info-circle"
              aria-hidden="true"
              title={T.translate("edit_registration_invitation.last_name_info")}
            />
            <Input
              id="last_name"
              className="form-control"
          ...
          <div className="col-md-4">
            ...
            <i
              className="fa fa-info-circle"
              aria-hidden="true"
              title={T.translate("edit_registration_invitation.email_info")}
            />
            <Input
              id="email"
              className="form-control"
        ...
        <div className="row form-group">
          <div className="col-md-4">
            <label>
              {" "}
              {T.translate("edit_registration_invitation.acceptance_criteria")}
            </label>
        ...
        <div className="row form-group">
          <div className="col-md-12">
            <label>
              {" "}
              {T.translate("edit_registration_invitation.allowed_ticket_types")}
              &nbsp;
              <i
                className="fa fa-info-circle"
                aria-hidden="true"
                title={T.translate(
                  "edit_registration_invitation.allowed_ticket_types_info"
                )}
              />
            </label>
            <TicketTypesInput
          ...
          <div className="col-md-12">
            ...
            <TagInput
              ...
              placeholder={T.translate(
                "edit_registration_invitation.placeholders.tags"
              )}
            />
          </div>
        </div>
