...
export default class TicketComponent extends React.Component {
  ...
  handleTicketLink = (ev, ticket) => {
    ...
    ev.preventDefault();
    history.push(
      `/app/summits/${summit.id}/purchase-orders/${ticket.order_id}/tickets/${ticket.id}`
    );
  };
    ...
    return (
      <div className="ticket-component">
        <div className="row form-group">
          <div className="col-md-12">
            <legend>
              ...
              <a
                href=""
                className="btn btn-default btn-xs add-ticket pull-right"
                onClick={this.onAdd}
              >
            ...
            {tickets.map((t) => (
              ...
              >
                <a
                  href=""
                  className="ticket btn btn-default"
                ...
                {t.is_active && (
                  <a
                    href="#"
                    className="del-ticket btn btn-success"
                    onClick={(ev) => this.handleTicketLink(ev, t)}
                  >
                ...
                {!t.is_active && (
                  <a
                    href="#"
                    className="del-ticket btn btn-danger"
        ...
        <Modal
          ...
          dialogClassName="ticket-edit-modal"
        >
          <Modal.Header closeButton>
            <Modal.Title>
              {T.translate("edit_attendee.ticket_details")}
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            {editTicket && (
              <div className="row">
                <div className="col-md-4">
                  ...
                  <div>
                    {
                      summit.ticket_types.find(
                        (t) => t.id === editTicket.ticket_type_id
                      ).name
                    }
                  </div>
                </div>
                {summit.external_registration_feed_type === "none" && (
                  <div className="col-md-4">
                    <label>{T.translate("edit_attendee.badge_type")}</label>
                    <br />
                    <div>{editTicket.badge.type.name}</div>
                  </div>
                )}
                {summit.external_registration_feed_type === "none" &&
                  editTicket.hasOwnProperty("promo_code") && (
                    <div className="col-md-4">
                      <label>{T.translate("edit_attendee.promo_code")}</label>
                      <br />
                ...
                {summit.external_registration_feed_type !== "none" && (
                  <div className="col-md-4">
                    <label>
                      {T.translate("edit_attendee.eb_order_number")}
                    </label>
                    <br />
                ...
                {summit.external_registration_feed_type !== "none" && (
                  <div className="col-md-4">
                    <label>{T.translate("edit_attendee.eb_attendee_id")}</label>
                    <br />
            ...
            <div className="row">
              <div className="col-md-8">
                <label>{T.translate("edit_attendee.assign_to_member")}</label>
                <br />
                <MemberInput
                  id="member"
          ...
          <Modal.Footer>
            <button
              ...
              onClick={this.handleTicketReassign}
            >
        ...
        <Modal
          show={showAddModal}
          onHide={this.onCloseModal}
          dialogClassName="ticket-add-modal"
        >
          <Modal.Header closeButton>
          ...
          <Modal.Body>
            <div className="row">
              ...
              {summit.external_registration_feed_type !== "none" && (
                <div className="col-md-4">
                  <label>{T.translate("edit_attendee.eb_order_number")}</label>
                  <br />
                  <input
