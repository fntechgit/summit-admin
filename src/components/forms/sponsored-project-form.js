...
import SponsoredProjectInput from "openstack-uicore-foundation/lib/components/sponsored-project-input"
...
class SponsoredProjectForm extends React.Component {
  ...
  handleEditSponsorshipType(id) {
    ...
    history.push(
      `/app/sponsored-projects/${entity.id}/sponsorship-types/${id}`
    );
  }
      ...
      <form className="sponsored-project-form">
          ...
          <div className="col-md-3 checkboxes-div">
            <div className="form-check abc-checkbox">
              ...
              <label
                ...
                htmlFor="should_show_on_nav_bar"
              >
        ...
        <div className="row form-group">
          ...
          <div className="col-md-4">
            <label>
              {" "}
              {T.translate("edit_sponsored_project.parent_project")}
            </label>
          ...
          <>
            <div className="row form-group">
              <div className="col-md-12">
                <button
                  ...
                  onClick={this.handleAddSponsorshipType}
                >
            ...
            <div className="row form-group">
              <div className="col-md-12">
                <button
                  className="btn btn-primary pull-right"
                  onClick={this.handleAddSubproject}
                >
