...
class LocationForm extends React.Component {
  ...
  handleFloorEdit(floorId) {
    const { currentSummit, history, entity } = this.props;
    history.push(
      `/app/summits/${currentSummit.id}/locations/${entity.id}/floors/${floorId}`
    );
  }
  ...
  handleRoomEdit(roomId) {
    const { currentSummit, history, entity } = this.props;
    history.push(
      `/app/summits/${currentSummit.id}/locations/${entity.id}/rooms/${roomId}`
    );
  }
  ...
  handleImageEdit(imageId) {
    const { currentSummit, history, entity } = this.props;
    history.push(
      `/app/summits/${currentSummit.id}/locations/${entity.id}/images/${imageId}`
    );
  }
  ...
  handleMapEdit(mapId) {
    const { currentSummit, history, entity } = this.props;
    history.push(
      `/app/summits/${currentSummit.id}/locations/${entity.id}/maps/${mapId}`
    );
  }
    ...
    return (
      <form className="location-form">
        ...
        <div className="row form-group">
          <div className="col-md-4">
            ...
            <Dropdown
              ...
              placeholder={T.translate(
                "edit_location.placeholders.select_type"
              )}
              options={location_class_ddl}
          ...
          <div className="col-md-4">
            ...
            <Input
              ...
              onChange={this.handleChange}
              error={this.hasErrors("short_name")}
            />
          </div>
        </div>
        ...
        <div className="row form-group">
          ...
          {this.display("hotel_type") && (
            <div className="col-md-4">
              ...
              <Dropdown
                id="hotel_type"
                value={entity.hotel_type}
                placeholder={T.translate(
                  "edit_location.placeholders.select_type"
                )}
                options={hotel_type_ddl}
                onChange={this.handleChange}
              />
            </div>
          )}
          {this.display("airport_type") && (
            <div className="col-md-4">
              ...
              <Dropdown
                id="airport_type"
                value={entity.airport_type}
                placeholder={T.translate(
                  "edit_location.placeholders.select_type"
                )}
                options={airport_type_ddl}
                onChange={this.handleChange}
              />
            </div>
          )}
        ...
        {this.display("address_1") && (
          <Panel
            show={showSection === "address"}
            title={T.translate("edit_location.address")}
          ...
          >
            ...
            <div className="row form-group">
              ...
              <div className="col-md-4">
                ...
                <CountryDropdown
                  ...
                  onChange={this.handleChange}
                  placeholder={T.translate(
                    "edit_location.placeholders.select_country"
                  )}
                />
              </div>
            </div>
            <div className="row form-group">
              ...
              <div className="col-md-4">
                <button
                  className="btn btn-default update_map"
        ...
        {this.display("floors") && entity.id !== 0 && (
          <Panel
            show={showSection === "floors"}
            title={T.translate("edit_location.floors")}
            handleClick={this.toggleSection.bind(this, "floors")}
          >
            <button
              className="btn btn-primary pull-right"
              onClick={this.handleNewFloor}
            >
        ...
        {this.display("images") && entity.id !== 0 && (
          <Panel
            show={showSection === "images"}
            title={T.translate("edit_location.images")}
