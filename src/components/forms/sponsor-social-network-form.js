...
const SponsorSocialNetworkForm = ({ entity, errors, onSubmit }) => {
  ...
  useEffect(() => {
    const customIcon =
      ...
      !iconsDDL.some((e) => e.value === entity.icon_css_class);
    if (customIcon) {
      setIconsDDL([
        ...iconsDDL,
        { label: entity.icon_css_class, value: entity.icon_css_class }
      ]);
    }
    ...
    const ddl_value =
      entity.icon_css_class instanceof Object || entity.icon_css_class == null
        ? entity.icon_css_class
        : iconsDDL.find((opt) => opt.value == entity.icon_css_class);
  ...
  useEffect(() => {
    ...
    const ddl_value =
      stateEntity.icon_css_class instanceof Object ||
      stateEntity.icon_css_class == null
        ? stateEntity.icon_css_class
        : iconsDDL.find((opt) => opt.value == stateEntity.icon_css_class);
    setTheValue(ddl_value);
        ...
        <div className="row form-group">
          ...
          <div className="col-md-4">
            ...
            <CreatableSelect
              ...
              value={theValue}
              onChange={(ev) =>
                handleChange({ target: { ...ev, id: "icon_css_class" } })
              }
              onCreateOption={handleNewSocialNetwork}
              options={iconsDDL}
            />
          </div>
          <div className="col-md-4 checkboxes-div">
            <div className="form-check abc-checkbox">
              <input
                type="checkbox"
                id="is_enabled"
                checked={stateEntity.is_enabled}
                onChange={handleChange}
