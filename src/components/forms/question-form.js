...
class QuestionForm extends React.Component {
  ...
  shouldShowField(field) {
    ...
    let entity_type = this.props.questionClasses.find(
  ...
  render() {
    ...
    let question_class_ddl = questionClasses.map((c) => ({
      label: c.class_name,
      value: c.class_name
    }));
    ...
    if (entity.values.length > 0) {
      question_values_ddl = entity.values.map((v) => ({
        label: v.value,
        value: v.id
      }));
    }
          ...
          {this.shouldShowField("default_value_id") && (
            <div className="col-md-3">
              ...
              <Dropdown
                ...
                placeholder={T.translate(
                  "question_form.placeholders.select_default"
                )}
          ...
          {this.shouldShowField("is_country_selector") && (
            <div className="col-md-3 checkboxes-div">
              <div className="form-check abc-checkbox">
                <input
                  type="checkbox"
                  id="is_country_selector"
                  checked={entity.is_country_selector}
                  onChange={this.handleChange}
                  className="form-check-input"
                />
                <label
                  className="form-check-label"
                  htmlFor="is_country_selector"
                >
          ...
          {this.shouldShowField("use_chosen_plugin") && (
            <div className="col-md-3 checkboxes-div">
              <div className="form-check abc-checkbox">
                <input
                  type="checkbox"
                  id="use_chosen_plugin"
                  checked={entity.use_chosen_plugin}
                  onChange={this.handleChange}
                  className="form-check-input"
                />
