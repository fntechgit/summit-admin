...
const Index = ({ onChange, id, operatorInitialValue, filterInitialValue }) => {
    ...
    const operatorOptions = [
        { label: T.translate("email_filter.placeholders.operator_contains"), value: 'owner_email=@' },
        { label: T.translate("email_filter.placeholders.operator_not_contains"), value: 'not_owner_email=@' },
        { label:T.translate("email_filter.placeholders.operator_equal"), value: 'owner_email==' },
    ];
