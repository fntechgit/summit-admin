    ...
    const summitItems = [
      {
        name: "audit_log",
        iconClass: "fa-tasks",
        linkUrl: `summits/${summit_id}/audit-log`,
        accessRoute: "audit-log"
      },
      {
        name: "dashboard",
        iconClass: "fa-dashboard",
        linkUrl: `summits/${summit_id}/dashboard`,
        accessRoute: "general"
      },
      {
        name: "events",
        ...
        childs: [
          ...
          { name: "event_types", linkUrl: `summits/${summit_id}/event-types` },
          {
            ...
            linkUrl: `summits/${summit_id}/event-categories`
          },
          {
            name: "event_category_groups",
            linkUrl: `summits/${summit_id}/event-category-groups`
          },
          {
            name: "voteable_presentations",
            linkUrl: `summits/${summit_id}/voteable-presentations`
          },
          {
            name: "media_uploads",
            linkUrl: `summits/${summit_id}/media-uploads`
          }
        ]
      },
      {
        ...
        childs: [
          {
            name: "attendee-list",
            linkUrl: `summits/${summit_id}/attendees`,
            accessRoute: "attendees"
          },
          {
            name: "badge_checkin",
            linkUrl: `summits/${summit_id}/attendees/checkin`
          }
        ]
      },
      {
        ...
        childs: [
          {
            ...
            iconClass: "fa-ticket",
            linkUrl: `summits/${summit_id}/submission-invitations`,
            accessRoute: "speakers"
          },
          {
            name: "speakers",
            iconClass: "fa-users",
            linkUrl: `summits/${summit_id}/speakers`,
            accessRoute: "speakers"
          },
          {
            name: "speaker_attendance",
            iconClass: "fa-users",
            linkUrl: `summits/${summit_id}/speaker-attendances`,
            accessRoute: "speakers"
          },
          {
            name: "featured_speakers",
            iconClass: "fa-star",
            linkUrl: `summits/${summit_id}/featured-speakers`,
            accessRoute: "speakers"
          }
        ]
      },
        ...
        childs: [
          {
            ...
            linkUrl: `summits/${summit_id}/track-chairs`
          },
          {
            name: "progress_flags",
            linkUrl: `summits/${summit_id}/track-chairs/progress-flags`,
            accessRoute: "progress-flags"
          },
          {
            name: "track_timeframes",
            linkUrl: `summits/${summit_id}/track-chairs/track-timeframes`,
      ...
      },
      {
        ...
        childs: [
          {
            name: "sponsor_list",
            linkUrl: `summits/${summit_id}/sponsors`,
            accessRoute: "sponsors"
          },
          {
            name: "sponsorship_list",
            linkUrl: `summits/${summit_id}/sponsorships`,
            accessRoute: "admin-sponsors"
          },
          {
            name: "sponsors_promocodes",
            linkUrl: `summits/${summit_id}/sponsors/promocodes`,
            accessRoute: "admin-sponsors"
          },
          {
            name: "badge_scans",
            linkUrl: `summits/${summit_id}/badge-scans`,
      ...
      },
      {
        ...
        linkUrl: `summits/${summit_id}/locations`,
        accessRoute: "locations"
      },
      {
        name: "signage",
        iconClass: "fa-map-signs",
        linkUrl: `summits/${summit_id}/signage`,
        accessRoute: "signage"
      },
      {
        name: "rsvps",
        ...
        childs: [
          {
            ...
            linkUrl: `summits/${summit_id}/rsvp-templates`
          }
        ]
      },
      {
        ...
        childs: [
          {
            ...
            linkUrl: `summits/${summit_id}/purchase-orders`
          },
          { name: "ticket_list", linkUrl: `summits/${summit_id}/tickets` },
          {
            name: "order_extra_questions",
            linkUrl: `summits/${summit_id}/order-extra-questions`
          },
          {
            name: "registration_stats",
            linkUrl: `summits/${summit_id}/registration-stats`
          }
        ]
      },
      {
        ...
        childs: [
          {
            ...
            linkUrl: `summits/${summit_id}/registration-invitations`
          },
          {
            name: "ticket_type_list",
            linkUrl: `summits/${summit_id}/ticket-types`
          },
          {
            name: "promocode_list",
            linkUrl: `summits/${summit_id}/promocodes`
          },
          { name: "tax_type_list", linkUrl: `summits/${summit_id}/tax-types` },
          {
            name: "refund_policy_list",
            linkUrl: `summits/${summit_id}/refund-policies`
          },
          {
            name: "payment_profiles_list",
            linkUrl: `summits/${summit_id}/payment-profiles`
          },
          {
            name: "registration_companies_list",
            linkUrl: `summits/${summit_id}/registration-companies`
          }
        ]
      },
      {
        ...
        childs: [
          {
            ...
            linkUrl: `summits/${summit_id}/badge-features`
          },
          {
            name: "access_level_list",
            linkUrl: `summits/${summit_id}/access-levels`
          },
          {
            name: "view_type_list",
            linkUrl: `summits/${summit_id}/view-types`
          },
          {
            name: "badge_type_list",
            linkUrl: `summits/${summit_id}/badge-types`
          },
          {
            name: "badge_settings",
            linkUrl: `summits/${summit_id}/badge-settings`
          }
        ]
      },
      {
        ...
        linkUrl: `summits/${summit_id}/room-bookings`,
      ...
      },
      {
        ...
        linkUrl: `summits/${summit_id}/push-notifications`,
        accessRoute: "push-notifications"
      },
      {
        name: "room_occupancy",
        iconClass: "fa-male",
        linkUrl: `summits/${summit_id}/room-occupancy`,
        accessRoute: "room-occupancy"
      },
      {
        name: "tag_groups",
        iconClass: "fa-tags",
        linkUrl: `summits/${summit_id}/tag-groups`,
        accessRoute: "tag-groups"
      },
      {
        name: "reports",
        iconClass: "fa-list-ol",
        linkUrl: `summits/${summit_id}/reports`,
        accessRoute: "reports"
      },
      {
        name: "summitdocs",
        iconClass: "fa-file-text",
        linkUrl: `summits/${summit_id}/summitdocs`,
        ...
        childs: [
          {
            ...
            linkUrl: `summits/${summit_id}/email-flow-events`
          },
          {
            name: "email_flow_settings",
            linkUrl: `summits/${summit_id}/email-flow-events-settings`
          }
        ]
      },
      {
        ...
        childs: [
          { name: "marketing", linkUrl: `summits/${summit_id}/marketing` },
          {
            ...
            linkUrl: `summits/${summit_id}/schedule-settings`
          }
        ]
      }
    ];
