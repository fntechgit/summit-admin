      ...
      <div className="container">
        ...
        {currentSummit && (
          <RoomForm
            ...
            locationHours={{
              opening_hour: currentLocation.opening_hour,
              closing_hour: currentLocation.closing_hour
            }}
            allFloors={allFloors}
            entity={entity}
            errors={errors}
            onSubmit={this.props.saveRoom}
            onAttributeLink={(attribute) => {
              this.props.addAttributeToRoom(
                currentLocation.id,
                entity.id,
                attribute
              );
            }}
            onAttributeUnLink={(attributeId) => {
              this.props.removeAttributeFromRoom(
                currentLocation.id,
                entity.id,
                attributeId
              );
