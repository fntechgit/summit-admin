...
class FeaturedSpeakersPage extends React.Component {
  ...
  render() {
    ...
    const columns = [
      ...
      {
        columnKey: "big_pic_bool",
        value: T.translate("featured_speakers.big_pic")
      }
    ];
    ...
    return (
      <div className="container">
        <h3>
          {" "}
          {T.translate("featured_speakers.featured_speakers")} ({totalSpeakers})
        </h3>
        <div className={"row"}>
          <div className={"col-md-6"}>
            <FreeTextSearch
              ...
              placeholder={T.translate(
                "featured_speakers.placeholders.search_featured_speakers"
              )}
