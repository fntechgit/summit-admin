...
class SummitEventListPage extends React.Component {
  ...
  handleChangeStartDate(ev, lastDate) {
    ...
    this.setState({
      ...
      eventFilters: {
        ...this.state.eventFilters,
        start_date_filter: lastDate
          ? [start_date_filter[0], value.unix()]
          : [value.unix(), start_date_filter[1]],
      },
    });
  }
  ...
  handleChangeEndDate(ev, lastDate) {
    ...
    this.setState({
      ...
      eventFilters: {
        ...this.state.eventFilters,
        end_date_filter: lastDate
          ? [end_date_filter[0], value.unix()]
          : [value.unix(), end_date_filter[1]],
      },
    });
  }
