...
class SummitEventListPage extends React.Component {
  ...
  render(){
    const {currentSummit, events, lastPage, currentPage, order, orderDir, totalEvents, term, extraColumns, filters, bulkUpdateEvents} = this.props;
    const {enabledFilters, eventFilters, selectedFilterCriteria, page} = this.state;
