...
const TicketTypeListPage = ({
  ...
  const handlePageChange = (page) => {
    props.getTicketTypes(currentSummit, order, orderDir, page, perPage, {
      audienceFilter
    });
  };
  ...
  const handleChangeAudienceFilter = (ev) => {
    ...
    props.getTicketTypes(currentSummit, order, orderDir, currentPage, perPage, {
  ...
  const handleDelete = (ticketTypeId) => {
    ...
    Swal.fire({
      ...
      text:
        T.translate("ticket_type_list.remove_warning") + " " + ticketType.name,
      type: "warning",
  ...
  const handleSort = (index, key, dir, func) => {
    props.getTicketTypes(currentSummit, key, dir, currentPage, perPage, {
      audienceFilter
    });
  };
  ...
  const handleChangeCurrency = (currency) => {
    Swal.fire({
      title: T.translate("general.are_you_sure"),
      text:
        T.translate("ticket_type_list.change_currency_warning") +
        " " +
        currency,
      type: "warning",
      showCancelButton: true,
  ...
  const columns = [
    ...
    {
      columnKey: "audience",
      value: T.translate("ticket_type_list.audience"),
      sortable: true
    },
    {
      columnKey: "badge_type_name",
      value: T.translate("ticket_type_list.badge_type_name")
    },
    {
      columnKey: "external_id",
      value: T.translate("ticket_type_list.external_id")
    }
  ];
