...
class RefundPolicyListPage extends React.Component {
  ...
  render() {
    const { currentSummit, match, refundPolicies, totalRefundPolicies } =
      this.props;
    ...
    let refund_columns = [
      { columnKey: "name", value: T.translate("refund_policy_list.name") },
      {
        ...
        value: T.translate("refund_policy_list.rate")
      },
      {
        columnKey: "until_x_days_before_event_starts",
        value: T.translate("refund_policy_list.days_before")
      }
    ];
    ...
    return (
      <>
        <Breadcrumb
          data={{
            title: T.translate("refund_policy_list.refund_policies"),
            pathname: match.url
          }}
        />
