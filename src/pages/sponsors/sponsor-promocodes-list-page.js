...
const SponsorPromocodesListPage = ({
  currentSummit,
  promocodes,
  lastPage,
  currentPage,
  ...
  const handleSendEmails = (ev) => {
    ...
    if (!currentFlowEvent) {
      Swal.fire(
        "Validation error",
        T.translate("sponsor_promocodes_list.select_template"),
        "warning"
      );
      return false;
    }
    ...
    if (selectedCount === 0) {
      Swal.fire(
        "Validation error",
        T.translate("sponsor_promocodes_list.select_items"),
        "warning"
      );
      return false;
    }
    ...
    if (testRecipient !== "" && !validateEmail(testRecipient)) {
      Swal.fire(
        "Validation error",
        T.translate("sponsor_promocodes_list.invalid_recipient_email"),
        "warning"
      );
      return false;
    }
      ...
      text: `${T.translate("sponsor_promocodes_list.send_email_warning", {
        ...
        qty: selectedCount
                ...
                ${
                  testRecipient
                    ? T.translate(
                        "sponsor_promocodes_list.email_test_recipient",
                        { email: testRecipient }
                      )
                    : ""
                }
  ...
  const handleEdit = (promocodeId) => {
    props.history.push(
      `/app/summits/${currentSummit.id}/sponsors/promocodes/${promocodeId}`
    );
  };
  ...
  const handleNewPromocode = () => {
    props.history.push(
      `/app/summits/${currentSummit.id}/sponsors/promocodes/new#type=sponsor`
    );
  };

  let columns = [
    {
      columnKey: "sponsor_company_name",
      value: T.translate("sponsor_promocodes_list.sponsor"),
      sortable: true
    },
    {
      columnKey: "tier_name",
      value: T.translate("sponsor_promocodes_list.tier"),
      sortable: true
    },
    {
      columnKey: "code",
      value: T.translate("sponsor_promocodes_list.code"),
      sortable: true
    },
    {
      ...
      render: (row, val) => {
        return parseInt(val) === 0
          ? T.translate("sponsor_promocodes_list.infinite")
          : val;
      },
      sortable: true
    },
    {
      columnKey: "quantity_used",
      value: T.translate("sponsor_promocodes_list.quantity_used"),
      sortable: true
    },
    {
      columnKey: "email_sent",
      value: T.translate("sponsor_promocodes_list.email_sent"),
      sortable: true
    }
  ];
  ...
  const ddl_columns = [
    {
      value: "feature_types",
      label: T.translate("sponsor_promocodes_list.feature_types")
    },
    {
      value: "ticket_types",
      label: T.translate("sponsor_promocodes_list.ticket_types")
    },
    {
      value: "contact_email",
      label: T.translate("sponsor_promocodes_list.contact_email")
    },
  ...
  const flowEventsDDL = [
    ...
    {
      label: "SPONSOR_PROMOCODE_EMAIL",
      value: "SUMMIT_REGISTRATION_SPONSOR_PROMO_CODE"
    }
  ];
  ...
  return (
    <div className="container">
      ...
      <h3>
        {" "}
        {T.translate("sponsor_promocodes_list.promocodes_list")} (
        {totalPromocodes})
      </h3>
      <div className={"row"}>
        <div className={"col-md-8"}>
          <FreeTextSearch
            ...
            placeholder={T.translate(
              "sponsor_promocodes_list.placeholders.search_promocodes"
            )}
      ...
      <div className={"row"} style={{ marginBottom: 15, marginTop: 15 }}>
        ...
        <div className={"col-md-5"}>
          <Input
            ...
            placeholder={T.translate(
              "sponsor_promocodes_list.placeholders.test_recipient"
            )}
      ...
      <div className={"row"} style={{ marginBottom: 15, marginTop: 15 }}>
        <div className={"col-md-6"}>
          ...
          <Dropdown
            id="select_fields"
            placeholder={T.translate(
              "sponsor_promocodes_list.placeholders.select_fields"
            )}
      ...
      {promocodes.length > 0 && (
        <div>
          {selectedCount > 0 && (
            <span>
              <b>
                {T.translate("sponsor_promocodes_list.items_qty", {
                  qty: selectedCount
                })}
              </b>
            </span>
