...
class SponsorPromocodesListPage extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <OrAndFilter style={{marginTop: 15}} value={attendeeFilters.orAndFilter} entity={'attendees'}
              ...
              <SegmentedControl
                ...
                options={[
                  {label: "All", value: null, default: attendeeFilters.virtualCheckInFilter === null},
                  {
                    ...
                    default: attendeeFilters.virtualCheckInFilter === "HAS_VIRTUAL_CHECKIN"
                  },
                  {
        ...
        {attendees.length > 0 &&
          <div>
            {selectedCount > 0 &&
              <span><b>{T.translate("attendee_list.items_qty", {qty: selectedCount})}</b></span>
            }
            <SelectableTable
