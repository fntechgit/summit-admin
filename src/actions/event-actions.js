...
export const getEvents =
  ...
  async (dispatch, getState) => {
    ...
    const params = {
      expand:
        "speakers,type,created_by,track,sponsors,selection_plan,location,tags,media_uploads,media_uploads.media_upload_type,actions",
      relations:
