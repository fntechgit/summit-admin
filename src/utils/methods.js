...
export const trim = (string, length) =>
  string.length > length
    ? `${string.substring(0, length - ELLIPSIS_LENGTH)}...`
    : string;
...
export const handleDDLSortByLabel = (ddlArray) => ddlArray.sort((a, b) => a.label.localeCompare(b.label))
