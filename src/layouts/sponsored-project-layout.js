  ...
  render() {
    ...
    return (
      <div>
        <Breadcrumb
          data={{
            title: T.translate("sponsored_project_list.sponsored_projects"),
            pathname: match.url
          }}
        />
        <Switch>
          <Route
            ...
            exact
            path={match.url}
            component={SponsoredProjectListPage}
          />
          <Route
            path={`${match.url}/:sponsored_project_id(\\d+)`}
            component={SponsoredProjectLayoutId}
          />
          <Route
            exact
            strict
...
export default Restrict(
  withRouter(SponsoredProjectLayout),
  "sponsored-projects"
);
