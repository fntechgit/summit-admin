...
const ratingTypeReducer = (state = DEFAULT_STATE, action) => {
  ...
  switch (type) {
    ...
    case RECEIVE_SCORE_TYPES: {
      ...
      return {
        ...state,
        entity: { ...state.entity, score_types: [...entity.data] }
      };
    }
    case RATING_TYPE_SCORE_TYPE_REMOVED: {
      const { scoreTypeId } = payload;
      const scoreTypes = state.entity.score_types.filter(
        (t) => t.id !== scoreTypeId
      );
    ...
    case RATING_TYPE_SCORE_TYPE_ADDED: {
      ...
      return {
        ...
        entity: {
          ...state.entity,
          score_types: [...state.entity.score_types, scoreType]
        }
      };
    }
    case RATING_TYPE_SCORE_TYPE_ORDER_UPDATED: {
      ...
      return {
        ...state,
        entity: { ...state.entity, score_types: score_types }
      };
    }
    case VALIDATE: {
