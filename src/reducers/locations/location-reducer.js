    ...
    case LOCATION_GMAP_UPDATED:
      {
        ...
        return {
          ...state,
          entity: { ...state.entity, lat: location.lat(), lng: location.lng() }
        };
      }
      break;
    case LOCATION_ADDRESS_UPDATED:
      {
        ...
        let { location } = payload[0].geometry;
        let st_nmbr = address.find(
          (l) => l.types.indexOf("street_number") !== -1
        ).short_name;
        let street = address.find(
          (l) => l.types.indexOf("route") !== -1
        ).short_name;
        let city = address.find(
          (l) => l.types.indexOf("locality") !== -1
        ).short_name;
        let loc_state = address.find(
          (l) => l.types.indexOf("administrative_area_level_1") !== -1
        ).short_name;
        let country = address.find(
          (l) => l.types.indexOf("country") !== -1
        ).short_name;
    ...
    case FLOOR_ADDED:
      {
        ...
        return {
          ...
          entity: {
            ...state.entity,
            floors: [...state.entity.floors, response]
          }
        };
      }
      break;
    case FLOOR_UPDATED:
      {
        ...
        return {
          ...state,
          entity: { ...state.entity, floors: [...floors, response] }
        };
      }
      break;
    case FLOOR_DELETED:
      {
        ...
        return {
          ...
          entity: {
            ...state.entity,
            floors: state.entity.floors.filter((f) => f.id !== floorId)
          }
        };
      }
      break;
    case ROOM_ADDED:
      {
        ...
        return {
          ...state,
          entity: { ...state.entity, rooms: [...state.entity.rooms, response] }
        };
      }
      break;
    case ROOM_DELETED:
    ...
    case LOCATION_IMAGE_DELETED:
      {
        ...
        return {
          ...
          entity: {
            ...state.entity,
            images: state.entity.images.filter((i) => i.id !== imageId)
          }
        };
      }
      break;
    case LOCATION_MAP_DELETED:
      {
        ...
        return {
          ...
          entity: {
            ...state.entity,
            maps: state.entity.maps.filter((m) => m.id !== mapId)
          }
        };
      }
      break;
