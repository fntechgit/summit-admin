    ...
    case ATTRIBUTE_ADDED:
      {
        ...
        return {
          ...
          entity: {
            ...state.entity,
            attributes: [...state.entity.attributes, attribute]
          }
        };
      }
      break;
    case ATTRIBUTE_REMOVED:
      {
        ...
        let attributes = state.entity.attributes.filter(
          (at) => at.id !== attributeId
        );
        return {
          ...state,
          entity: { ...state.entity, attributes: attributes }
        };
      }
      break;
    case VALIDATE:
