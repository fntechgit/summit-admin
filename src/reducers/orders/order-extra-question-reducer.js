  ...
  switch (type) {
    ...
    case ORDER_EXTRA_QUESTION_VALUE_DELETED: {
      ...
      return {
        ...
        entity: {
          ...state.entity,
          values: state.entity.values.filter(
            (v) => v.id !== orderExtraQuestionValueId
          )
        }
      };
    }
    case ORDER_EXTRA_QUESTION_SUB_QUESTION_ADDED: {
      ...
      return {
        ...
        entity: {
          ...state.entity,
          sub_question_rules: [
            ...state.entity.sub_question_rules,
            newSubQuestion
          ]
        }
      };
    ...
    case ORDER_EXTRA_QUESTION_SUB_QUESTION_UPDATED: {
      ...
      const subQuestionRules = state.entity.sub_question_rules.filter(
        (v) => v.id !== entity.id
      );
      return {
        ...state,
        entity: {
          ...state.entity,
          sub_question_rules: [...subQuestionRules, entity]
        }
      };
    }
    case ORDER_EXTRA_QUESTION_SUB_QUESTION_DELETED: {
      ...
      return {
        ...
        entity: {
          ...state.entity,
          sub_question_rules: state.entity.sub_question_rules.filter(
            (v) => v.id !== ruleId
          )
        }
      };
