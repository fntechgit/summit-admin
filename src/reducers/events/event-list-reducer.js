  ...
  switch (type) {
    ...
    case RECEIVE_EVENTS: {
      ...
      let events = payload.response.data.map((e) => {
        let published_date = e.is_published
          ? moment(e.published_date * 1000)
              .tz(state.summitTZ)
        ...
        return {
          ...
          duration: e.type.allows_publishing_dates
            ...
            : "N/A",
          speakers_count: e.type.use_speakers
            ? e.speakers && e.speakers.length > 0
              ? e.speakers.length
              : "0"
            : "N/A",
          ...
          tags:
            e.tags && e.tags.length > 0
              ...
              : "N/A",
          selection_plan: e.selection_plan?.name
            ? e.selection_plan?.name
            : "N/A",
          ...
          start_date: e.start_date
            ? moment(e.start_date * 1000)
                .tz(state.summitTZ)
                .format("MMMM Do YYYY, h:mm a")
            : "TBD",
          end_date: e.end_date
            ? moment(e.end_date * 1000)
                .tz(state.summitTZ)
                .format("MMMM Do YYYY, h:mm a")
            : "TBD",
          sponsor: e.sponsors
            ...
            : "N/A",
          created: e.created
            ? moment(e.created * 1000)
                .tz(state.summitTZ)
                .format("MMMM Do YYYY, h:mm a")
            : "TBD",
          modified: e.last_edited
            ? moment(e.last_edited * 1000)
                .tz(state.summitTZ)
                .format("MMMM Do YYYY, h:mm a")
            : "TBD",
          media_uploads: e?.media_uploads?.map((m) => ({
            ...m,
            created: moment(m.created * 1000)
              .tz(state.summitTZ)
              .format("MMMM Do YYYY, h:mm a")
          })),
