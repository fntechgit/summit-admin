...
// Suppress console.error noise from known jsdom/MUI incompatibilities:
...
//      lenient but jsdom reports it. No test assertions depend on it.
const originalError = console.error.bind(console);
console.error = (...args) => {
  const msg = typeof args[0] === "string" ? args[0] : "";
  if (msg.includes("cannot appear as a descendant of")) {
    return;
  }
  originalError(...args);
};
...
// lifecycle names. react-router-dom v5 and connected-react-router trigger
